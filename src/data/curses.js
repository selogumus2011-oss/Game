...
export const CURSES = {
  // --- Fodder ---------------------------------------------------------------
  larva: C({
    id: 'larva', name: 'Cursed Larva', grade: 4,
  ...
  grinner: C({
    id: 'grinner', name: 'Grinning Mouth', grade: 4,
  ...
  // --- Grade 3 --------------------------------------------------------------
  mantis: C({
    id: 'mantis', name: 'Scythe Curse', grade: 3,
  ...
  wraith: C({
    id: 'wraith', name: 'Veil Wraith', grade: 3,
  ...
  // --- Grade 2 --------------------------------------------------------------
  hulkCurse: C({
    id: 'hulkCurse', name: 'Rampart Curse', grade: 2,
  ...
  serpent: C({
    id: 'serpent', name: 'Coil Curse', grade: 2,
  ...
  // --- Grade 1 --------------------------------------------------------------
  fingerBearer: C({
    id: 'fingerBearer', name: 'Finger Bearer', grade: 1,
  ...
  hanged: C({
    id: 'hanged', name: 'Hanged Curse', grade: 1,
  ...
  // --- Special grade --------------------------------------------------------
  disasterCurse: C({
    id: 'disasterCurse', name: 'Disaster Curse', grade: 'special',
  ...
  // --- Shikigami & summons --------------------------------------------------
  divineDog: C({
    id: 'divineDog', name: 'Divine Dog: Totality', grade: 2,
  ...
  greatSerpent: C({
    id: 'greatSerpent', name: 'Great Serpent', grade: 2,
  ...
  mahoraga: C({
    id: 'mahoraga', name: 'Divine General Mahoraga', grade: 'special',
  ...
  transfigured: C({
    id: 'transfigured', name: 'Transfigured Human', grade: 3,
  ...
  isomer: C({
    id: 'isomer', name: 'Polymorphic Soul Isomer', grade: 1,
  ...
  curseGrade2: C({
    id: 'curseGrade2', name: 'Bound Curse', grade: 2,
  ...
  rika: C({
    id: 'rika', name: 'Rika', grade: 'special',
  ...
  garuda: C({
    id: 'garuda', name: 'Bomb: Garuda', grade: 2,
  ...
  tideFish: C({
    id: 'tideFish', name: 'Tide Shikigami', grade: 3,
  ...
  decoy: C({
    id: 'decoy', name: 'Cursed Double', grade: 4,
