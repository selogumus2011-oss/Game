...
export const EXTRA_TECHNIQUES = {
  ...
  divergentFist: {
    ...
    abilities: [
      {
        id: 'divergentStrike', name: 'Divergent Fist: Full', jp: '逕庭拳・全力',
      ...
      {
        id: 'manjiKick', name: 'Manji Kick', jp: '卍蹴り',
      ...
      {
        id: 'blackFlashFocus', name: 'Focus', jp: '集中',
        ...
        onCast(ctx) { ctx.world.banner('集中', 'Focus — the window widens', '#ff6b5a', 1.6); },
      },
      {
        id: 'vesselRelease', name: 'Vessel: Partial Release', jp: '受肉・部分解放',
        ...
        onCast(ctx) {
          ...
          ctx.world.banner('受肉', 'Partial Release', '#ff4d4d', 1.8);
        },
      },
    ],
    domain: null,
  ...
  // =========================================================================
  // COPY — 模倣 (and the cursed spirit that follows you)
  // =========================================================================
  copyTechnique: {
    id: 'copyTechnique',
    name: 'Copy',
    ...
    abilities: [
      {
        id: 'rikaManifest', name: 'Rika: Manifest', jp: '里香・顕現',
        ...
        onCast(ctx) {
          ctx.world.banner('里香', 'Rika', '#ff8ab0', 1.8);
          ctx.world.shake(10, 0.6);
        },
      },
      {
        id: 'rikaBleed', name: 'Rika: Devour', jp: '里香・喰',
      ...
      {
        id: 'castCopied', name: 'Copied Technique', jp: '模倣発動',
      ...
      {
        id: 'pureLove', name: 'Rika: Complete Manifestation', jp: '里香・完全顕現',
        ...
        onCast(ctx) {
          ctx.world.banner('完全顕現', 'Complete Manifestation', '#ff8ab0', 2.4);
    ...
    domain: {
      id: 'authenticMutualLove', name: 'Authentic Mutual Love', jp: '真贋相愛',
  ...
  iceFormation: {
    ...
    abilities: [
      {
        id: 'iceFang', name: 'Ice Fang', jp: '氷牙',
      ...
      {
        id: 'frostField', name: 'Frost Calm: Field', jp: '霜凪・氷面',
      ...
      {
        id: 'icefall', name: 'Ice Formation: Icefall', jp: '氷凝・堕氷',
      ...
      {
        id: 'absoluteZero', name: 'Ice Formation: Absolute', jp: '氷凝・絶対零度',
        ...
        onCast(ctx) {
          ctx.world.banner('絶対零度', 'Absolute Zero', '#a8e8ff', 2);
    ...
    domain: {
      id: 'frozenSanctuary', name: 'Frozen Sanctuary', jp: '氷凝の庭',
  ...
  idleDeathGamble: {
    ...
    passive: {
      name: 'Private Pure Love Train', jp: '純愛列車',
    ...
    abilities: [
      {
        id: 'overflow', name: 'Overflow', jp: '打ち出し',
      ...
      {
        id: 'reelRush', name: 'Reel Rush', jp: '連打',
      ...
      {
        id: 'spin', name: 'Spin the Reels', jp: '回転',
        ...
        onCast(ctx) {
          ...
          if (roll < odds) {
            ...
            ctx.world.banner('当たり', 'Hit — the reels pay out', '#ffd166', 1.6);
      ...
      {
        id: 'jackpot', name: 'JACKPOT', jp: '大当たり',
        ...
        onCast(ctx) {
          ...
          ctx.world.banner('大当たり', 'JACKPOT — unlimited reversal', '#ffd166', 3);
    ...
    domain: {
      id: 'idleDeathGambleDomain', name: 'Idle Death Gamble', jp: '坐殺博徒',
  ...
  starRage: {
    ...
    abilities: [
      {
        id: 'massPunch', name: 'Mass Punch', jp: '質量拳',
      ...
      {
        id: 'gravityWell', name: 'Gravity Well', jp: '重力井戸',
      ...
      {
        id: 'garuda', name: 'Bomb: Garuda', jp: '星の怒り・迦楼羅',
      ...
      {
        id: 'infiniteMass', name: 'Star Rage: Infinite Mass', jp: '星の怒り・無限質量',
        ...
        onCast(ctx) {
          ...
          ctx.world.banner('無限質量', 'Infinite Mass', '#c9a0ff', 1.8);
        },
      },
    ],
    domain: null,
  ...
  electricDischarge: {
    ...
    passive: {
      name: 'Mythical Beast Amber', jp: '幻獣琥珀',
    ...
    abilities: [
      {
        id: 'thunderclap', name: 'Thunderclap', jp: '雷鳴',
      ...
      {
        id: 'overcharge', name: 'Overcharge', jp: '過充電',
      ...
      {
        id: 'chainBolt', name: 'Chain Bolt', jp: '連雷',
      ...
      {
        id: 'amberRelease', name: 'Mythical Beast Amber: Release', jp: '幻獣琥珀・解放',
        ...
        onCast(ctx) {
          ...
          ctx.world.banner('幻獣琥珀', 'Mythical Beast Amber', '#ffe066', 2);
        },
      },
    ],
    domain: null,
  ...
  disasterTides: {
    ...
    abilities: [
      ...
      {
        id: 'shikigamiShoal', name: 'Shikigami: Shoal', jp: '式神・群魚',
      ...
      {
        id: 'undertow', name: 'Undertow', jp: '引き波',
      ...
      },
      {
        ...
        onCast(ctx) { ctx.world.shake(20, 1.2); ctx.world.banner('津波', 'Tsunami', '#6fd0e8', 1.8); },
      },
    ],
    domain: {
      id: 'captivatingSkandha', name: 'Horizon of the Captivating Skandha', jp: '蕩蘊平線',
  ...
  construction: {
    ...
    passive: {
      name: 'Perfect Construction', jp: '完全構築',
    ...
    abilities: [
      {
        id: 'spikeField', name: 'Construct: Spikes', jp: '構築・棘',
      ...
      {
        id: 'steelBarrage', name: 'Construct: Barrage', jp: '構築・連射',
      ...
      {
        id: 'perfectBlade', name: 'Construct: Perfect Blade', jp: '構築・完全刃',
      ...
      {
        id: 'sublimeArt', name: 'Sublime Art: Mode — Sphere', jp: '生得領域「星の怒り」',
        ...
        sfx: 'fire',
        onCast(ctx) { ctx.world.shake(20, 1.2); ctx.world.banner('完全構築', 'Sublime Art', '#e8c46a', 1.8); },
      },
    ],
    domain: null,
  ...
  puppetManipulation: {
    ...
    passive: {
      name: 'Inverted Restriction', jp: '逆天与呪縛',
    ...
    abilities: [
      {
        id: 'puppetGuard', name: 'Puppet: Guard', jp: '傀儡・守',
      ...
      {
        id: 'missileBarrage', name: 'Missile Barrage', jp: '弾幕',
      ...
      {
        id: 'absoluteMode', name: 'Ultimate Mechamaru: Absolute', jp: '機械丸・絶対',
        ...
        tags: ['buff'], vfx: 'buffAura', sfx: 'cast',
        onCast(ctx) { ctx.world.banner('絶対', 'Absolute Mode', '#9fb8c8', 1.8); },
      },
      {
        id: 'ultimateCannon', name: 'Ultimate Cannon', jp: '超高出力砲',
        ...
        onCast(ctx) {
          ...
          ctx.world.slowmo(0.3, 0.7);
          ctx.world.banner('超高出力', 'Ultimate Cannon', '#b8e8ff', 1.8);
        },
      },
    ],
    domain: null,
