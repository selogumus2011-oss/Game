...
export const ARENAS = {
  shibuya: {
    id: 'shibuya', floor: 'tiles', name: 'Shibuya Station, Halloween',
    size: 56,
  ...
  jujutsuHigh: {
    id: 'jujutsuHigh', floor: 'grass', name: 'Jujutsu High Training Grounds',
    size: 60,
  ...
  shrine: {
    id: 'shrine', floor: 'stone', name: 'Ruined Shrine',
    size: 50,
  ...
  cullingIsland: {
    id: 'cullingIsland', floor: 'asphalt', name: 'Culling Game Colony',
    size: 96,
  ...
  void: {
    id: 'void', floor: 'void', name: 'Training Void',
    size: 44,
